        ...
        <b-row>
            <b-col md="6">
                <b-form-group label="Nome*" label-for="name" label-size="lg">
                    ...
                    <b-form-input id="mc-first-name" v-model="name" placeholder="Insira o nome do autor" />
                </b-form-group>
            </b-col>
            <b-col md="6">
                <b-form-group label="Sobrenome*" label-for="last_name" label-size="lg">
                    <span class="text-muted fs-2">Obrigatório</span>
                    <b-form-input id="last_name" v-model="last_name" placeholder="Insira o sobrenome do autor" />
                </b-form-group>
            </b-col>
            <b-col md="6">
            ...
            <b-col class="d-flex align-items-center justify-content-center">
                <b-button @click="editAutor()" v-ripple.400="'rgba(186, 191, 199, 0.15)'" type="submit"
                    variant="primary" class="mt-4 mr-1" size="lg">
                    Enviar
                </b-button>
                

                <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" type="reset" variant="outline-secondary"
                    class="mr-1 mt-4" size="lg">
                    Cancelar
                </b-button>
            </b-col>b-col>
        </b-row>
