        ...
        <b-row>
            <b-col md="6">
                ...
                <b-form-group label="Nome*" label-for="name" label-size="lg">
                        ...
                        <b-form-input v-model="name" placeholder="Insira o nome do autor" />
            ...
            <b-col md="6">
                <b-form-group label="Endereço" label-for="address" label-size="lg">
                    ...
                    <b-form-input id="address" v-model="address" placeholder="Insira o endereço da editora" />
                </b-form-group>
            </b-col>
            ...
            <b-col cols="12" class="d-flex align-items-center justify-content-center mt-2">
                <b-button @click="editEditora()" v-ripple.400="'rgba(186, 191, 199, 0.15)'" size="lg" type="submit"
