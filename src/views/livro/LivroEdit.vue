            ...
            <validation-observer ref="simpleRules">
                ...
                <b-form id="form" @submit.prevent>
                    <b-row>
                        ...
                        <b-col md="3">
                            <b-form-group label="Selecione a editora*" label-for="name" label-size="lg">
                                <v-select v-model="publishing_company_id" :value="editoras.name"
                                    :reduce="editoras => editoras.id" :options="
                                    editoras" label="name" />
                        ...
                        <b-col cols="12" class="d-flex align-items-center justify-content-center mt-2">
                            <b-button @click="editLivro()" v-ripple.400="'rgba(186, 191, 199, 0.15)'" size="lg"
